    ...
    <div className="homePage flex flex-col w-full min-h-screen">
      ...
      <div className="flex gap-10 mt-24">
        ...
        <div className="main flex w-full flex-col mt-2 mr-10">
          ...
          <div className="flex justify-between w-full h-full border-[1px] border-gray-500/80 shadow-4xl shadow-gray-900 my-4">
            <div className="flex m-5 w-full shadow-2xl ml-0 mt-0 rounded-xl gap-3">
