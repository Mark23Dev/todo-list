    ...
    <div className="homePage flex flex-col w-full min-h-screen bg-blue-200">
      ...
      <div className="flex gap-10 mt-24">
        ...
        <div className="main flex w-full flex-col mt-2 mr-10">
          ...
          <div className="flex w-full h-full border-[1px] border-blue-500 shadow-4xl shadow-gray-900 my-5">
            <div className="flex m-3 w-full shadow-3xl rounded-xl gap-3">
              {/* <div className="flex shadow-2xl rounded-md h-full m-2"></div> */}
              {/* <div className="flex shadow-2xl rounded-md h-full m-2"></div> */}
