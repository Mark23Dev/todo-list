  ...
  return (
    <div className="flex min-h-screen m-3 mt-6 gap-3 w-full">
      ...
      <div className="flex flex-1 flex-col min-h-screen rounded-2xl border-[1px] border-gray-500/80">
        ...
        <div className="">
          <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Saepe delectus voluptatibus iure!</p>
          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Doloribus soluta ipsam eligendi nulla ullam neque praesentium asperiores nesciunt, quo consequuntur et voluptatibus excepturi, voluptate hic, dignissimos veniam deleniti debitis fugit.</p>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quo perspiciatis adipisci repellat cupiditate modi optio. Quos harum sed alias quia.</p>
