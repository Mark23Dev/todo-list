        ...
        <div className="main flex w-full flex-col mt-2">
          <div className="heading flex w-full justify-between">
            ...
            <div className="invites flex gap-2">
              ...
              <button className="flex gap-2 items-center justify-center p-2 hover:bg-blue-800 hover:text-white hover:shadow-2xl text-blue-800  rounded-md border-2 border-blue-800">
                <FaPeopleGroup />
                Invite
              </button>
            </div>
