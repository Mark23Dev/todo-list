    ...
    <div className="flex min-h-screen m-3 mt-6 gap-3 w-full">
      ...
      <div className="flex flex-1 flex-col min-h-screen rounded-2xl border-[1px] border-gray-500/80">
        <div className="flex p-3 gap-2">
          ...
          <p className="min-w-0">Attend a Birthday party at Kilimani</p>
          <p className="min-w-0">Priority: Moderate</p>
          <p className="min-w-0">Status: In Progress</p>
          <p className="min-w-0">Created On: 23/08/2025</p>
        </div>
      </div>
    </div>
  );
