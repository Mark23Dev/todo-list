        ...
        <div className="main flex w-full flex-col mt-2 mr-10">
          <div className="heading flex w-full justify-between">
            ...
            <div className="invites flex gap-2">
              ...
              <button className="flex gap-2 items-center justify-center text-sm py-1 px-2 hover:bg-red-500/80 hover:text-white hover:shadow-2xl text-red-500/80  rounded-md border-2 border-red-500/80">
                <FaPeopleGroup />
                Invite
              </button>
            </div>
          </div>
          <div className="flex justify-between w-full h-full border-[1px] border-red-500/80 shadow-4xl shadow-gray-900 my-5">
            <div className="flex m-5 w-full shadow-2xl rounded-xl gap-3">
              <div className="flex flex-col flex-1 [box-shadow:0px_0_6px_rgba(0,0,0,0.1)] rounded-md h-96 m-2">
