      ...
      <div className="flex gap-10 mt-24">
        ...
        <div className="main flex w-full flex-col mt-2 mr-10">
          ...
          <div className="flex justify-between w-full h-full border-[1px] border-gray-500/80 shadow-4xl shadow-gray-900 my-5">
            <div className="flex flex-col md:flex-row items-center justify-center m-3 w-full shadow-2xl rounded-xl gap-3">
              <div className="flex flex-col flex-1 [box-shadow:0px_0_6px_rgba(0,0,0,0.1)] rounded-md p-3 m-0 max-w-6xl mx-auto">
              ...
              <div className="flex flex-1 rounded-md h-full m-2">
                <TaskStatus />
              </div>
