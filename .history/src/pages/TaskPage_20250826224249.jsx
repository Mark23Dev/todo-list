      ...
      <div className="flex flex-1 flex-col min-h-screen rounded-2xl border-[1px] border-gray-500/80">
        <div className="flex p-3 gap-2">
          ...
          <div className="items-baseline">
            <p className="text-[12px] mb-2">Attend a Birthday party at Kilimani</p>
            <p className="text-[10px] mb-2">Priority: Moderate</p>
            <p className="text-[10px] mb-2">Status: In Progress</p>
