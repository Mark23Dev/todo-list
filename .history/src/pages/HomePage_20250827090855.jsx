    ...
    <div className="main flex w-full flex-col mt-2 mx-3">
      <div className="heading flex w-full justify-between">
        ...
        <div className="invites flex gap-2">
          ...
          <button onClick={} className="flex gap-2 items-center justify-center text-sm py-1 px-2 hover:bg-red-500/80 hover:text-white hover:shadow-2xl text-red-500/80  rounded-md border-[1px] border-red-500/80">
            <FaPeopleGroup />
            Invite
          </button>
