import { FaHome, FaExclamationCircle, FaCheckSquare, FaList, FaCog, FaQuestionCircle, FaSignOutAlt } from "react-icons/fa6";

const SideBar = () => {
  return (
    <div className="sidebar relative w-64 min-h-screen mt-7 rounded-tr-lg bg-blue-800/70 backdrop-blur-md shadow-lg shadow-blue-900/50 p-4 text-white flex flex-col items-center">
      {/* Profile section */}
      ...
      <nav className="mt-6 w-full flex flex-col gap-3">
        <a href="#" className="flex items-center gap-3 px-4 py-2 rounded-lg bg-blue-700 hover:bg-blue-600 transition-colors">
          <FaHome /> Dashboard
        </a>
