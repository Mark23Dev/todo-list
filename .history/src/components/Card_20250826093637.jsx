      ...
      <div className="flex p-3 gap-2">
        ...
        <div className="content">
          ...
          <div className="status min-w-0 min-h-0">
            <span className="text-[10px] min-w-0">Priority: Moderate</span>
            <span className="text-[10px] min-w-0">Status: Not shared</span>
            <span className="text-[10px] min-w-0 text-gray-300">Created on: 20/08/2025</span>
          </div>
        </div>
      </div>
    </div>
