      ...
      <div className="invite-form flex flex-col absolute top-20 right-[30%] z-200 bg-white border-[1px] border-gray-500/80 w-100 h-100">
        ...
        <div className="card text-[12px] flex flex-col justify-between gap-2 p-3 border-[1px] border-gray-500/80 h-full m-3">
          ...
          <div className="flex search justify-between min-h-0 w-full">
            <input type="email" className="border-[1px] w-3/4 h-5 border-gray-500/80 rounded-md p-1" />
            <button className="bg-red-500/80 text-white  w-1/5 h-5 rounded-md p-1 mt-2 hover:bg-red-500/90">Send Invite</button>
          </div>
          <p>Members</p>
