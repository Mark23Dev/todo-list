...
const Card = () => {
  return(
    <div className="card flex flex-col border-[1px] m-2 rounded-2xl min-w-0">
      <div className="flex justify-between p-5">
        <div className="flex flex-2 flex-col items-center">
          
          <span className="min-h-0 font-extrabold text-[14px]">Attending a birthday party in Kilimani</span>
