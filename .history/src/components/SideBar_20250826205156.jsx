    ...
    <div className="sidebar relative w-64 min-h-screen mt-7 rounded-tr-lg bg-red-500/80 backdrop-blur-md shadow-lg shadow-blue-900/50 p-4 text-white flex flex-col items-center">
      ...
      <div className="relative w-full flex flex-col items-center">
        <div className="absolute -top-12">
          <div className="bg-white rounded-full w-20 h-20 flex items-center justify-center shadow-md border-2 border-white-500">
            {/* Replace with <img src="..." /> for real image */}
            <img className="object-contain rounded-full" src="https://randomuser.me/api/portraits/men/1.jpg" alt="" />
          </div>
        </div>
      ...
      <nav className="mt-6 w-full flex flex-col gap-3">
        ...
        <a href="/vital-tasks" className="flex items-center gap-3 px-4 py-2 rounded-lg hover:text-red-500/80 hover:bg-white transition-colors">
          <FaExclamationCircle /> Vital Task
        </a>
        <a href="/my-tasks" className="flex items-center gap-3 px-4 py-2 rounded-lg hover:text-red-500/80 hover:bg-white transition-colors">
