...
const Card = () => {
  return(
    <div className="card flex flex-col border-[1px] m-2 rounded-2xl h-40">
        ...
        <div className="content">
          <div className="flex justify-between">
            <div className="flex flex-2 flex-col items-center">
              ...
              <span className="min-h-0 font-extrabold text-[14px] mb-1">Attending a birthday party in Kilimani</span>
