        ...
        <div className="card text-[12px] flex flex-col gap-1 p-3 border-[1px] border-gray-500/80 m-3">
          ...
          <div className="flex">
            <div className="task-description flex flex-col">
              ...
              <textarea className="border-[1px] w-70 h-30 border-gray-500/80 rounded-sm mt-2 p-1 resize-none" placeholder="Start writing here..."></textarea>
            </div>
            <div className="upload-image flex flex-col">
              <p className="font-bold">Upload Image</p>
              <input type="file" className="border-[1px] w-30 h-30 border-gray-500/80 rounded-sm mt-2 p-1" />
            </div>
          </div>
