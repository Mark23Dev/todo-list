...
const Card = () => {
  return(
    <div className="card flex flex-col border-[1px] m-2 ml-0 rounded-2xl min-h-0">
      <div className="flex p-3 gap-2">
        ...
        <div className="content">
          ...
          <div className="status m-0">
            <span className="text-[10px] pl-3">Priority: Moderate</span>
            <span className="text-[10px]">Status: Not shared</span>
            <span className="text-[10px] text-gray-300">Created on: 20/08/2025</span>
          </div>
        </div>
      </div>
    </div>
