      ...
      <div className="menu flex items-center gap-4">
        ...
        <div className="icons flex gap-2">
          <button className="bg-white/30 w-8 h-8 rounded-md flex items-center justify-center hover:bg-white/50 transition-colors duration-200">
            <FaBell className="bg-red-500/80 text-white w-4 h-4" />
          </button>
          <button className="bg-white/30 w-8 h-8 rounded-md flex items-center justify-center hover:bg-white/50 transition-colors duration-200">
            <FaCalendar className="bg-red-500/80 text-white w-4 h-4" />
          </button>
        </div>

        {/* Date */}
        <div className="date bg-red-500/80 text-white text-sm text-right">
