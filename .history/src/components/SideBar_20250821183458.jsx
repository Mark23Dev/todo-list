...
const SideBar = () => {
  return (
    <div className="sidebar relative w-54 min-h-screen mt-7 shadow-lg rounded-tr-lg bg-blue-800">
      {/* Profile icon at top center */}
      <div className="absolute -top-6 left-1/2 transform -translate-x-1/2 bg-white rounded-full w-12 h-12 flex items-center justify-center shadow-md">
        <FaPerson className="text-blue-800 w-6 h-6" />
      </div>

      {/* Sidebar content */}
      <nav className="flex flex-col gap-3 mt-12 p-4 text-white">
