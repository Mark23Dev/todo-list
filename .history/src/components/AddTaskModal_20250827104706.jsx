        ...
        <div className="card text-[12px] flex flex-col justify-between gap-2 p-3 border-[1px] border-gray-500/80 h-full m-3">
          <div className="title">
            ...
            <div className="flex search justify-between items-center min-h-0 w-full">
              <input type="text" className="border-[1px] w-3/4 h-8 border-gray-500/80 rounded-sm mt-2 p-1" />
            </div>
          </div>
          <div className="date">
            <p>Date</p>
            <div className="flex search justify-between items-center min-h-0 w-full">
              <input type="date" className="border-[1px] w-3/4 h-8 border-gray-500/80 rounded-sm mt-2 p-1" />
            </div>
          </div>
          ...
          <div className="flex">
            <div className="task-description flex flex-col">
              ...
              <textarea className="border-[1px] w-full h-20 border-gray-500/80 rounded-sm mt-2 p-1 resize-none" placeholder="Write a description..."></textarea>
            </div>
            <div className="upload-image flex flex-col"></div>
          </div>
