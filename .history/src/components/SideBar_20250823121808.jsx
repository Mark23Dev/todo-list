...
const SideBar = () => {
  return (
    <div className="sidebar relative w-64 min-h-screen mt-7 rounded-tr-lg bg-red-400/80 backdrop-blur-md shadow-lg shadow-blue-900/50 p-4 text-white flex flex-col items-center">
      {/* Profile section */}
