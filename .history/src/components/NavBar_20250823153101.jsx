...
const NavBar = () => {
  return (
    <div className="navbar flex z-100 fixed top-0 left-0 min-w-screen items-center justify-between px-8 py-5 bg-[#F9F4F4] shadow-2xl">
      {/* Logo */}
      <div className="logo">
        <h1 className="text-3xl font-bold text-red-500/80 tracking-wide drop-shadow-md">
          Dash<span className="text-black/80">Board</span>
        </h1>
      </div>
      ...
      <div className="menu flex items-center gap-4">
        ...
        <div className="icons flex gap-2">
          <button className="bg-red-500/80 w-8 h-8 rounded-md flex items-center justify-center hover:bg-red-600/80 transition-colors duration-200">
