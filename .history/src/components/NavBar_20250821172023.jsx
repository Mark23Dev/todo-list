...
const NavBar = () => {
  return (
    <div className="navbar flex justify-between p-2 shadow-lg shadow-black-200 bg-blue-1000">
      <div className="logo">
        <h1>DashBoard</h1>
      </div>
      <div className="search flex">
        <div className="searchbar flex justify-between bg-white p-3 rounded-lg">
